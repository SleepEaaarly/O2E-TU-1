			 ...
			 <u-row style="margin-bottom: 0%;">
			        ...
			        <u-col span="9">
						<u-row style="margin-top: 20px;">
							<text class = "companyTitle">{{title}}</text>
							
							<u-button type="primary" text="查看详情" size = "mini" style = "width: 100px;height: 28px;"></u-button>
...
<script>
	export default {
		name:"company_display_card",
		data() {
			return {
				
			};
		},
		props:['title','address','area','logoPath']
	}
</script>
