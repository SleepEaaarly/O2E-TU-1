        ...
        <template v-if="userInfo && userInfo.id">
            ...
            <view v-if="finisheditems">
                <view v-for="(item, index) in finisheditems" :key="index">
                    <need-list :item="item" :index="index" @openDetail="openDetail" :manage="true" :manage_finished="true"
            ...
            <view>
                ...
                <uni-popup ref="alertDialog" type="dialog">
                    <uni-popup-dialog :type="msgType" confirmText="同意" cancelText="关闭" title="提示" :content="msg"
                        @confirm="dialogConfirm(msgType)" @close="dialogClose"></uni-popup-dialog>
                </uni-popup>
            </view>
        </template>
        <template v-else>
