...
// export const baseUrl = process.env.NODE_ENV === 'development' ? "http://127.0.0.1:8000/api/" : "http://127.0.0.1:8000/api/";
// export const socketBaseUrl = process.env.NODE_ENV === 'development' ? "ws://127.0.0.1:8000/api/" : "ws://127.0.0.1:8000/api/";
